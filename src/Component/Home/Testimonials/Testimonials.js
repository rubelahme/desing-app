...
const Played = [
  {
    ...
    img: imgOne,
    lorem:
      "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odit beatae aperiam reiciendis dolor saepe ipsum, molestiae ullam, repudiandae sequi accusamus expedita nulla animi fugiat debitis impedit quibusdam quisquam dolore a?",
    img1: imgFour,
  },
  {
    name: "Miriam Barron",
        ...
        <div className="row">
          <div className="col">
            ...
            >
              {Played.map((pd) => (
                <SwiperSlide>
                  <SwiperSlidePage data={pd}></SwiperSlidePage>
                </SwiperSlide>
              ))}
            </Swiper>
          </div>
